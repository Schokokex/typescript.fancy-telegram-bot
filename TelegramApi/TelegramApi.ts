...
export default abstract class TelegramApi {
	...
	async setWebhook(obj: {
		...
		return this.fetch('setWebhook', {
			...
			allowed_updates: obj.allowed_updates,
			drop_pending_updates: obj.drop_pending_updates,
		});
	}
	...
	async sendMessage(obj: {
		...
		return this.fetch('sendMessage', {
			...
			disable_notification: obj.disable_notification,
			reply_to_message_id: obj.reply_to_message_id,
			allow_sending_without_reply: obj.allow_sending_without_reply,
			reply_markup: obj.reply_markup,
		});
	}
	...
	async sendDocument(obj: {
		...
		return this.fetch('sendDocument', {
			...
			parse_mode: obj.parse_mode,
			caption_entities: obj.caption_entities,
			disable_content_type_detection: obj.disable_content_type_detection,
			disable_notification: obj.disable_notification,
			reply_to_message_id: obj.reply_to_message_id,
			allow_sending_without_reply: obj.allow_sending_without_reply,
			reply_markup: obj.reply_markup,
	...
	async sendAnimation(obj: {
		...
		return this.fetch('sendAnimation', {
			chat_id: obj.chat_id,
	...
	async sendVideoNote(obj: {
		...
		return this.fetch('sendVideoNote', {
			chat_id: obj.chat_id,
	...
	async sendMediaGroup(obj: {
		...
		return this.fetch('sendMediaGroup', {
			chat_id: obj.chat_id,
			media: obj.media,
			disable_notification: obj.disable_notification,
			reply_to_message_id: obj.reply_to_message_id,
	 ...
	 */
	async editMessageLiveLocation(obj: {
		latitude: number;
		longitude: number;
		chat_id?: number | string;
		message_id?: number;
		...
		return this.fetch('editMessageLiveLocation', {
			chat_id: obj.chat_id,
			message_id: obj.message_id,
	 ...
	 * @param reply_markup A JSON-serialized object for a new inline keyboard.
	 */
	async stopMessageLiveLocation(obj: {
		chat_id?: number | string;
		message_id?: number;
		inline_message_id?: string;
		reply_markup?: InlineKeyboardMarkup;
	}) {
		return this.fetch('stopMessageLiveLocation', {
			chat_id: obj.chat_id,
			message_id: obj.message_id,
			inline_message_id: obj.inline_message_id,
			reply_markup: obj.reply_markup,
	...
	async sendPoll(obj: {
		...
		return this.fetch('sendPoll', {
			...
			explanation_parse_mode: obj.explanation_parse_mode,
			explanation_entities: obj.explanation_entities,
	...
	async getUserProfilePhotos(obj: { user_id: number; offset?: number; limit?: number }) {
		return this.fetch('getUserProfilePhotos', {
			user_id: obj.user_id,
			offset: obj.offset,
			limit: obj.limit,
		});
	...
	async kickChatMember(obj: { chat_id: number | string; user_id: number; until_date?: number }) {
		return this.fetch('kickChatMember', {
			chat_id: obj.chat_id,
			user_id: obj.user_id,
	 ...
	 */
	async unbanChatMember(obj: {
		chat_id: number | string;
		user_id: number;
		only_if_banned?: boolean;
	}) {
		return this.fetch('unbanChatMember', {
			chat_id: obj.chat_id,
			user_id: obj.user_id,
			only_if_banned: obj.only_if_banned,
		});
	}
	 ...
	 */
	async restrictChatMember(obj: {
		chat_id: number | string;
		user_id: number;
		permissions: ChatPermissions;
		until_date?: number;
	}) {
		return this.fetch('restrictChatMember', {
			chat_id: obj.chat_id,
			user_id: obj.user_id,
	...
	async promoteChatMember(obj: {
		...
		return this.fetch('promoteChatMember', {
			chat_id: obj.chat_id,
			user_id: obj.user_id,
			is_anonymous: obj.is_anonymous,
	 ...
	 */
	async setChatAdministratorCustomTitle(obj: {
		chat_id: number | string;
		user_id: number;
		custom_title: string;
	}) {
		return this.fetch('setChatAdministratorCustomTitle', {
			chat_id: obj.chat_id,
			user_id: obj.user_id,
	...
	async setChatPermissions(obj: { chat_id: number | string; permissions: ChatPermissions }) {
		return this.fetch('setChatPermissions', {
			chat_id: obj.chat_id,
			permissions: obj.permissions,
		});
	}
	...
	async setChatPhoto(obj: { chat_id: number | string; photo: InputFile }) {
		return this.fetch('setChatPhoto', {
			chat_id: obj.chat_id,
			photo: obj.photo,
		});
	}
	...
	async setChatTitle(obj: { chat_id: number | string; title: string }) {
		return this.fetch('setChatTitle', {
			chat_id: obj.chat_id,
			title: obj.title,
		});
	}
	...
	async setChatDescription(obj: { chat_id: number | string; description?: string }) {
		return this.fetch('setChatDescription', {
			chat_id: obj.chat_id,
	 ...
	 */
	async pinChatMessage(obj: {
		chat_id: number | string;
		message_id: number;
		disable_notification?: boolean;
	}) {
		return this.fetch('pinChatMessage', {
			chat_id: obj.chat_id,
			message_id: obj.message_id,
			disable_notification: obj.disable_notification,
		});
	...
	async unpinChatMessage(obj: { chat_id: number | string; message_id?: number }) {
		return this.fetch('unpinChatMessage', {
			chat_id: obj.chat_id,
			message_id: obj.message_id,
		});
	}
	...
	async getChatMember(obj: { chat_id: number | string; user_id: number }) {
		return this.fetch('getChatMember', {
			chat_id: obj.chat_id,
			user_id: obj.user_id,
		});
	}
	...
	async setChatStickerSet(obj: { chat_id: number | string; sticker_set_name: string }) {
		return this.fetch('setChatStickerSet', {
			chat_id: obj.chat_id,
	...
	async answerCallbackQuery(obj: {
		...
		return this.fetch('answerCallbackQuery', {
			...
			text: obj.text,
			show_alert: obj.show_alert,
			url: obj.url,
			cache_time: obj.cache_time,
		});
	}
	...
	async editMessageCaption(obj: {
		...
		return this.fetch('editMessageCaption', {
			chat_id: obj.chat_id,
			message_id: obj.message_id,
			inline_message_id: obj.inline_message_id,
			caption: obj.caption,
	...
	async editMessageMedia(obj: {
		...
		return this.fetch('editMessageMedia', {
			chat_id: obj.chat_id,
			message_id: obj.message_id,
			inline_message_id: obj.inline_message_id,
			media: obj.media,
	 ...
	 * @param reply_markup A JSON-serialized object for an inline keyboard.
	 */
	async editMessageReplyMarkup(obj: {
		chat_id?: number | string;
		message_id?: number;
		inline_message_id?: string;
		reply_markup?: InlineKeyboardMarkup;
	}) {
		return this.fetch('editMessageReplyMarkup', {
			chat_id: obj.chat_id,
			message_id: obj.message_id,
			inline_message_id: obj.inline_message_id,
			reply_markup: obj.reply_markup,
	...
	async uploadStickerFile(obj: { user_id: number; png_sticker: InputFile }) {
		return this.fetch('uploadStickerFile', {
			user_id: obj.user_id,
			png_sticker: obj.png_sticker,
		});
	}
	...
	async createNewStickerSet(obj: {
		...
		return this.fetch('createNewStickerSet', {
			user_id: obj.user_id,
			name: obj.name,
			title: obj.title,
			png_sticker: obj.png_sticker,
			tgs_sticker: obj.tgs_sticker,
			emojis: obj.emojis,
			contains_masks: obj.contains_masks,
			mask_position: obj.mask_position,
		});
	}
	...
	async addStickerToSet(obj: {
		...
		return this.fetch('addStickerToSet', {
			user_id: obj.user_id,
			name: obj.name,
			png_sticker: obj.png_sticker,
			tgs_sticker: obj.tgs_sticker,
	...
	async setStickerPositionInSet(obj: { sticker: string; position: number }) {
		return this.fetch('setStickerPositionInSet', {
			sticker: obj.sticker,
	...
	async setStickerSetThumb(obj: { name: string; user_id: number; thumb?: InputFile | string }) {
		return this.fetch('setStickerSetThumb', {
			name: obj.name,
			user_id: obj.user_id,
			thumb: obj.thumb,
		});
	...
	async answerInlineQuery(obj: {
		...
		return this.fetch('answerInlineQuery', {
			inline_query_id: obj.inline_query_id,
			results: obj.results,
			cache_time: obj.cache_time,
			is_personal: obj.is_personal,
			next_offset: obj.next_offset,
			switch_pm_text: obj.switch_pm_text,
			switch_pm_parameter: obj.switch_pm_parameter,
		});
	}
	...
	async sendInvoice(obj: {
		...
		return this.fetch('sendInvoice', {
			chat_id: obj.chat_id,
			title: obj.title,
			description: obj.description,
			payload: obj.payload,
			provider_token: obj.provider_token,
			start_parameter: obj.start_parameter,
			currency: obj.currency,
			prices: obj.prices,
			provider_data: obj.provider_data,
			photo_url: obj.photo_url,
			photo_size: obj.photo_size,
			photo_width: obj.photo_width,
			photo_height: obj.photo_height,
			need_name: obj.need_name,
			need_phone_number: obj.need_phone_number,
			need_email: obj.need_email,
			need_shipping_address: obj.need_shipping_address,
			send_phone_number_to_provider: obj.send_phone_number_to_provider,
			send_email_to_provider: obj.send_email_to_provider,
	 ...
	 */
	async answerShippingQuery(obj: {
		shipping_query_id: string;
		ok: boolean;
		shipping_options?: ShippingOption[];
		error_message?: string;
	}) {
		return this.fetch('answerShippingQuery', {
			shipping_query_id: obj.shipping_query_id,
			ok: obj.ok,
			shipping_options: obj.shipping_options,
	 ...
	 */
	async answerPreCheckoutQuery(obj: {
		pre_checkout_query_id: string;
		ok: boolean;
		error_message?: string;
	}) {
		return this.fetch('answerPreCheckoutQuery', {
			pre_checkout_query_id: obj.pre_checkout_query_id,
			ok: obj.ok,
			error_message: obj.error_message,
		});
	}
	...
	async setPassportDataErrors(obj: { user_id: number; errors: any[] }) {
		return this.fetch('setPassportDataErrors', {
			user_id: obj.user_id,
			errors: obj.errors,
		});
	}
	...
	async setGameScore(obj: {
		...
		return this.fetch('setGameScore', {
			user_id: obj.user_id,
			score: obj.score,
			force: obj.force,
			disable_edit_message: obj.disable_edit_message,
			chat_id: obj.chat_id,
			message_id: obj.message_id,
			inline_message_id: obj.inline_message_id,
		});
	 ...
	 * @param inline_message_id Required if chat_id and message_id are not specified. Identifier of the inline message
	 */
	async getGameHighScores(obj: {
		user_id: number;
		chat_id?: number;
		message_id?: number;
		inline_message_id?: string;
	}) {
		return this.fetch('getGameHighScores', {
			user_id: obj.user_id,
			chat_id: obj.chat_id,
			message_id: obj.message_id,
			inline_message_id: obj.inline_message_id,
